...
import com.supming.test.KinderGarten.GartenFavoriteListAdapter;
 ...
 */
public class Favorite_Main extends Fragment implements SearchView.OnQueryTextListener{


    public Favorite_Main() {
        // Required empty public constructor
    }
    private ArrayList<Gartens> mgartensList;
    private DatabaseHelper mDBHelper;
    private GartenFavoriteListAdapter adapter ;
    ListView lv;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            View v = inflater.inflate(R.layout.fragment_main_favorite,null);
    ...
    public void upDate(View view){
        adapter = new GartenFavoriteListAdapter(this.getActivity(), mgartensList );
        lv = (ListView) view.findViewById(R.id.listfavorite);
    ...
    public ArrayList<Gartens> getMgartensList(){
        ...
        return  mDBHelper.getFavoriteListGartens();
    }
